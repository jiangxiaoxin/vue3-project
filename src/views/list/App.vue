...
<template>
  <div>
    ...
    <div v-bind="containerProps" class="h-300px overflow-auto p-2 bg-gray-500/5 rounded" style="height: 500px; background: red">
      <div v-bind="wrapperProps" >
        <div
          v-for="{ index, data } in list"
          :key="index"
          class="border border-$c-divider mb-2 list-item"
          :style="{
